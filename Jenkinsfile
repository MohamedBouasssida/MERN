pipeline {
    ...
    environment {
        ...
        IMAGE_NAME_SERVER = 'mohamedbouassida/mern-server' // Replace with your Docker Hub username
        IMAGE_NAME_CLIENT = 'mohamedbouassida/mern-client' // Replace with your Docker Hub username
    }
        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    git branch: 'main',
                        url: 'https://github.com/MohamedBouasssida/MERN.git',
